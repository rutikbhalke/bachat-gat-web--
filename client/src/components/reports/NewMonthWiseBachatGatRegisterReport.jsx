            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'center', fontSize: '0.95rem', color: '#000' }}>
              <thead>
                <tr style={{ borderBottom: '1.5px solid #000', fontWeight: 800 }}>
                  ...
                  <th style={{ borderRight: '1px solid #000', padding: '10px 8px', width: '90px' }}>कर्ज<br/>Loan Amount</th>
              ...
              <tbody>
                {data.map((row, idx) => (
                  <tr key={row.id || idx} style={{ borderBottom: '1px solid #000' }}>
                    ...
                    <td style={{ borderRight: '1px solid #000', padding: '8px 4px' }}>{row.loan ? formatCurrency(row.loan) : '-'}</td>
              ...
              {data.length > 0 && (
                <tfoot>
                  <tr style={{ borderTop: '2px solid #000', fontWeight: 900 }}>
                    <td colSpan="2" style={{ borderRight: '1px solid #000', padding: '10px 8px', textAlign: 'right' }}>एकूण / Grand Total:</td>
                    <td style={{ borderRight: '1px solid #000', padding: '10px 4px', textAlign: 'center' }}>-</td>
                    <td style={{ borderRight: '1px solid #000', padding: '10px 4px', textAlign: 'center' }}>-</td>
